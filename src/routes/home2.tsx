...
export const Route = createFileRoute("/home2")({
  head: () => ({
    meta: [
      { title: "Shortcut Home2 — A Maps-style look for the city app" },
      {
        name: "description",
        content:
          "Alternate Maps-inspired design of the Shortcut landing page. Shortcut finds live curbside and garage parking, corrects public transport times and guides you with live traffic, traffic-light countdowns and EV charging. Join the waitlist.",
      },
      { property: "og:title", content: "Shortcut Home2 — A Maps-style look" },
      {
        property: "og:description",
        content:
          "Alternate blue Maps-style theme. Live parking, sharper transit times, traffic-light countdowns and EV charging. An app by Civimatica, launching in Turin.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [{ rel: "canonical", href: "/home2" }],
  }),
  component: Home2,
});
